...
function Course_Detail_Advance(props) {
    return (
       <main>
  {/* =======================
Page content START */}
          ...
          <div className="row g-4">
            ...
            <div className="col-12">
              ...
              <ul className="list-inline mb-0">
                <li className="list-inline-item fw-light h6 me-3 mb-1 mb-sm-0"><i className="fas fa-star me-2" />4.5/5.0</li>
                <li className="list-inline-item fw-light h6 me-3 mb-1 mb-sm-0"><i className="fas fa-user-graduate me-2" />12k Enrolled</li>
                <li className="list-inline-item fw-light h6 me-3 mb-1 mb-sm-0"><i className="fas fa-signal me-2" />All levels</li>
                <li className="list-inline-item fw-light h6 me-3 mb-1 mb-sm-0"><i className="bi bi-patch-exclamation-fill me-2" />Last updated 09/2021</li>
                <li className="list-inline-item fw-light h6"><i className="fas fa-globe me-2" />English</li>
              </ul>
            </div>
            {/* Title END */}
            {/* Image and video */}
                    ...
                    <div className="col-12">
                      ...
                      <div className="d-sm-flex justify-content-sm-between align-items-center">
                        <div className="d-flex">
                          <a href="#" className="btn btn-light btn-round mb-0 flex-shrink-0"><i className="bi bi-lock-fill" /></a>
                          <div className="ms-2 ms-sm-3 mt-1 mt-sm-0">	
                            <h6 className="mb-0">How to Write Like Your Customers Talk</h6>
                            <p className="mb-2 mb-sm-0 small">22m 26s</p>
                          </div>
                        </div>
                        {/* Button */}
                    ...
                    <div className="col-12">
                      ...
                      <div className="d-sm-flex justify-content-sm-between align-items-center">
                        <div className="d-flex">
                          <a href="#" className="btn btn-danger-soft btn-round mb-0 flex-shrink-0"><i className="fas fa-play" /></a>
                          <div className="ms-2 ms-sm-3 mt-1 mt-sm-0">	
                            <h6 className="mb-0">Internal and External Links</h6>
                      ...
                      <div className="d-sm-flex justify-content-sm-between align-items-center">
                        <div className="d-flex">
                          <a href="#" className="btn btn-danger-soft btn-round mb-0 flex-shrink-0"><i className="fas fa-play" /></a>
                          <div className="ms-2 ms-sm-3 mt-1 mt-sm-0">	
                            <h6 className="mb-0">Measuring SEO Effectiveness</h6>
...
export default Course_Detail_Advance;