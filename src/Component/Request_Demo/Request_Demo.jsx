      ...
      <div className="row g-4 g-md-5 justify-content-between">
        ...
        <div className="col-lg-6 mb-5 mb-lg-0">
          ...
          <ul className="list-group list-group-borderless mt-3 mb-sm-5">
            <li className="list-group-item h6 fw-light d-flex"><i className="fas fa-check-circle fa-fw text-success me-2" />An overview of the platform and its features</li>
            <li className="list-group-item h6 fw-light d-flex"><i className="fas fa-check-circle fa-fw text-success me-2" />Share few success stories with you</li>
            <li className="list-group-item h6 fw-light d-flex"><i className="fas fa-check-circle fa-fw text-success me-2" />Actionable learning functionality</li>
            <li className="list-group-item h6 fw-light d-flex"><i className="fas fa-check-circle fa-fw text-success me-2" />No communication gap</li>
            <li className="list-group-item h6 fw-light d-flex"><i className="fas fa-check-circle fa-fw text-success me-2" />Better addressable of group level issue</li>
            <li className="list-group-item h6 fw-light d-flex"><i className="fas fa-check-circle fa-fw text-success me-2" />Unlimited access to 5K+ Courses</li>
          </ul>
          {/* Client slider START */}
          <div className="row justify-content-center">
            ...
            <div className="col-md-12">
              ...
              <div className="tiny-slider arrow-round">
                <div className="tiny-slider-inner" data-arrow="false" data-dots="false" data-gutter={80} data-items={3} data-items-sm={2} data-autoplay={2000}>
                  {/* Slide item START */}
          ...
          <div className="bg-dark rounded-3 p-4 p-sm-5 position-relative">
            ...
            <form className="row g-3 position-relative">
              ...
              <div className="col-md-6 bg-dark-input"> 
                <label className="form-label text-white text-opacity-50">First name <span className="text-danger">*</span></label>
                <input type="text" className="form-control" id="firstName" />
              </div>
              {/* Last name */}
              <div className="col-md-6 bg-dark-input"> 
                <label className="form-label text-white text-opacity-50">Last name <span className="text-danger">*</span></label>
                <input type="text" className="form-control" id="lastName" />
              </div>
              {/* Email */}
              <div className="col-md-6 bg-dark-input"> 
                <label className="form-label text-white text-opacity-50">Email <span className="text-danger">*</span></label>
                <input type="email" className="form-control" id="email" />
              </div>
              {/* Phone number */}
              <div className="col-md-6 bg-dark-input"> 
                <label className="form-label text-white text-opacity-50">Phone number <span className="text-danger">*</span></label>
                <input type="text" className="form-control" id="phoneNumber" />
              </div>
              {/* Company name */}
              <div className="col-md-6 bg-dark-input"> 
                <label className="form-label text-white text-opacity-50">City <span className="text-danger">*</span></label>
                <input type="text" className="form-control" id="companyName" />
              </div>
              {/* Company Size */}
              <div className="col-md-6 bg-dark-input"> 
                <label className="form-label text-white text-opacity-50">First language <span className="text-danger">*</span></label>
                <input type="text" className="form-control" id="companySize" />
              </div>
              <div className="col-12 bg-dark-input"> 
                <label className="form-label text-white text-opacity-50">Additional note(s)</label>
