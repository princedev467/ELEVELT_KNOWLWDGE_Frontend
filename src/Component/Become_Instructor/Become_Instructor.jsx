...
function Become_Instructor(props) {
    return (
      <main>
  {/* =======================
Page Banner START */}
    ...
    <div className="container position-relative">
      <div className="row g-4 align-items-center">
        <div className="col-md-6">
          ...
          {/* Button */}
          <a href="#fill-instructor-form" className="btn btn-primary mb-0">Start Teaching today</a>
        </div>
        <div className="col-md-6 text-center">
          {/* Image */}
          <img src="assets/images/element/04.svg" className="h-300px h-xl-400px" alt />
        </div>
      </div>
    </div>
  </section>
    ...
    <div className="container">
      ...
      <div className="row g-4 g-md-5">
        ...
        <div className="col-md-4 text-center">
          <img src="assets/images/element/create-account.svg" className="h-200px" alt />
        ...
        {/* Item */}
        <div className="col-md-4 text-center">
          <img src="assets/images/element/add-course.svg" className="h-200px" alt />
        ...
        {/* Item */}
        <div className="col-md-4 text-center">
          <img src="assets/images/element/earn-money.svg" className="h-200px" alt />
    ...
    <div className="container">
      <div className="bg-orange bg-opacity-10 p-4 p-sm-5 rounded position-relative overflow-hidden">
        ...
        <figure className="position-absolute top-50 end-0 translate-middle-y me-n7">
          <svg className="fill-white opacity-8 rotate-193" width="676px" height="161.3px" viewBox="0 0 676 161.3" style={{enableBackground: 'new 0 0 676 161.3'}} xmlSpace="preserve">
        ...
        <div className="row g-4 position-relative align-items-center justify-content-center">
          ...
          <div className="col-sm-6 col-lg-3 text-center">
            <div className="d-flex justify-content-center">
              <h4 className="purecounter display-6 text-orange fw-bold mb-0" data-purecounter-start={0} data-purecounter-end={89} data-purecounter-delay={200}>0</h4>
              <span className="display-6 text-orange mb-0">K</span>
            </div>
          ...
          <div className="col-sm-6 col-lg-3 text-center">
            <div className="d-flex justify-content-center">
              <h4 className="purecounter display-6 text-orange fw-bold mb-0" data-purecounter-start={0} data-purecounter-end={25} data-purecounter-delay={200}>0</h4>
              <span className="display-6 text-orange mb-0">K</span>
            </div>	
            <h6 className="mb-0 fw-bold">Total Instructors</h6>
          </div>
          {/* Counter item */}
          <div className="col-sm-6 col-lg-3 text-center">
            <div className="d-flex justify-content-center">
              <h4 className="purecounter display-6 text-orange fw-bold mb-0" data-purecounter-start={0} data-purecounter-end={180} data-purecounter-delay={200}>0</h4>
              <span className="display-6 text-orange mb-0">K</span>
            </div>
            <h6 className="mb-0 fw-bold">Total Courses</h6>
          </div>
          {/* Counter item */}
          <div className="col-sm-6 col-lg-3 text-center">
            <div className="d-flex justify-content-center">
              <h4 className="purecounter display-6 text-orange fw-bold mb-0" data-purecounter-start={0} data-purecounter-end={20} data-purecounter-delay={200}>0</h4>
              <span className="display-6 text-orange mb-0">+</span>
            </div>
            <h6 className="mb-0 fw-bold">Languages</h6>
          </div>
        </div> {/* Row END */}
      </div>
    </div>
    ...
    <div className="container">
      <div className="row">
          ...
          <div className="card card-body shadow p-4">
            ...
            <form className="row g-3 mt-2 position-relative z-index-9">
              ...
              <div className="col-12">
                ...
                <textarea className="form-control" rows={3} spellCheck="false" defaultValue={""} />
              </div>
              {/* Button */}
              <div className="col-12">
        ...
        <div className="col-lg-7 z-index-9 mt-5 mt-xl-0">
          ...
          <ul className="nav nav-pills nav-pill-soft my-4" id="course-pills-tab" role="tablist">
            {/* Tab item */}
            <li className="nav-item me-2 me-lg-4" role="presentation">
              <button className="nav-link mb-2 mb-xl-0 active" id="course-pills-tab-1" data-bs-toggle="pill" data-bs-target="#course-pills-1" type="button" role="tab" aria-controls="course-pills-1" aria-selected="true">Become an Instructor</button>
            </li>
            {/* Tab item */}
            <li className="nav-item me-2 me-lg-4" role="presentation">
              <button className="nav-link mb-2 mb-xl-0" id="course-pills-tab-2" data-bs-toggle="pill" data-bs-target="#course-pills-2" type="button" role="tab" aria-controls="course-pills-2" aria-selected="false">Instructor Role</button>
            </li>
            {/* Tab item */}
            <li className="nav-item me-2 me-lg-4" role="presentation">
              <button className="nav-link mb-2 mb-xl-0" id="course-pills-tab-3" data-bs-toggle="pill" data-bs-target="#course-pills-3" type="button" role="tab" aria-controls="course-pills-3" aria-selected="false">Start with Course</button>
            </li>
          </ul>
          {/* Tab contents START */}
            ...
            <div className="tab-pane fade" id="course-pills-2" role="tabpanel" aria-labelledby="course-pills-tab-2">
              ...
              <ul className="list-group list-group-borderless mb-3">
                <li className="list-group-item">
                  <i className="fas fa-check-circle text-success me-2" />The copy warned the Little blind text
                </li>
                <li className="list-group-item d-flex">
                  <i className="fas fa-check-circle text-success me-2 mt-1" />Thar where it came from it would have been rewritten a thousand times and everything that was left from origin would be the world
                </li>
                <li className="list-group-item">
                  <i className="fas fa-check-circle text-success me-2" />Return to it's own,safe country
                </li>
              </ul>
            </div>
            {/* Content */}
