          ...
          <div className="card border rounded-3 p-2 p-sm-4 h-100">
            ...
            <div className="card-header p-0">
              ...
              <div className="d-flex justify-content-between align-items-center p-3 bg-light rounded-2">
                ...
                <div>
                  ...
                  <div className="badge bg-dark mb-0 rounded-pill">Most popular</div>
                </div>
                {/* Price */}
                <div>
                  <h4 className="text-success mb-0 plan-price" data-monthly-price="$20" data-annual-price="$570">$20</h4>
            ...
            <div className="card-body pt-0">
              <ul className="list-unstyled mt-2 mb-0">
                ...
                <li className="mb-3 h6 fw-light"><i className="bi bi-x-octagon-fill text-danger me-2" />24/7 dedicated Support</li>
                <li className="mb-3 h6 fw-light"><i className="bi bi-x-octagon-fill text-danger me-2" />Unlimited updates</li>
                <li className="h6 fw-light"><i className="bi bi-x-octagon-fill text-danger me-2" />Landing pages &amp; Web widgets</li>
              </ul>
            </div>
            {/* Card Footer */}
          ...
          <div className="card border rounded-3 p-2 p-sm-4 h-100">
            ...
            <div className="card-header p-0">
              ...
              <div className="d-flex justify-content-between align-items-center p-3 bg-light rounded-2">
                {/* Info */}
                <div>
                  <h5 className="mb-0">Professional</h5>
                  <div className="badge bg-grad mb-0 rounded-pill">Recommended</div>
                </div>
                {/* Price */}
                <div>
                  <h4 className="text-success mb-0 plan-price" data-monthly-price="$59" data-annual-price="$840">$59</h4>
                  <p className="small mb-0">/ per user</p>
                </div>
              </div>
            </div>
            ...
            <div className="card-header p-0">
              ...
              <div className="d-flex justify-content-between align-items-center p-3 bg-light rounded-2">
                ...
                <div>
                  ...
                  <div className="badge bg-dark mb-0 rounded-pill">Best value</div>
                </div>
                {/* Price */}
                <div>
                  <h4 className="text-success mb-0 plan-price" data-monthly-price="$99" data-annual-price="$999">$99</h4>
                  <p className="small mb-0">/ per user</p>
                </div>
              </div>
            </div>
            ...
            <div className="col-md-6 pt-2 pt-md-0">
              <div className="row">
                ...
                <div className="col-4 d-flex justify-content-center">
                  <div className="icon-md bg-success bg-opacity-10 rounded-circle text-success"><i className="fas fa-check" /></div>
                </div>
                {/* Check */}
                <div className="col-4 d-flex justify-content-center">
                  <div className="icon-md bg-success bg-opacity-10 rounded-circle text-success"><i className="fas fa-check" /></div>
