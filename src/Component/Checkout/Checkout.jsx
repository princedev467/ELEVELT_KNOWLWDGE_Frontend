...
import { useGetCouponQuery } from '../../Redux/Api/coupon.Api';
import { useGetCartQuery, useUpdateCartMutation } from '../../Redux/Api/Cart.Api';
...
function Checkout(props) {
  ...
  console.log(cartUser);
    ...
    const originalPrice  = cartUser?.items?.reduce((acc, v) => {
            ...
            <div className="col-xl-8 mb-4 mb-sm-0">
              ...
              <div className="alert alert-danger alert-dismissible d-flex justify-content-between align-items-center fade show py-2 pe-2" role="alert">
                <div>
                  ...
                  Already have an account? <a href="#" className="text-reset btn-link mb-0 fw-bold">Log in</a>
                </div>
                        ...
                        <div id="collapse-2" className="accordion-collapse collapse" aria-labelledby="heading-2" data-bs-parent="#accordioncircle">
                          ...
                          <div className="accordion-body">
                            ...
                            <form className="row text-start g-3">
                              <p className="mb-1">In order to complete your transaction, we will
                                transfer you over to Eduport secure servers.</p>
                              <p className="my-0">Select your bank from the drop-down list and
              ...
              <div className="row mb-0">
                <div className="col-md-6 col-xl-12">
                  ...
                  <div className="card card-body shadow p-4 mb-4">
                    ...
                    {/* Course item START */}
                    {
                      cartUser?.items?.map((item) => {

                        const cartCourse = courseData?.data?.find(
                          (course) => course._id === item.course
                        );

                        if (!cartCourse) return null;

                        return (
                          <div key={cartCourse._id}>
                            <div className="row g-3">
                              ...
                              <div className="col-sm-4">
                                <Carousel indicators={false}>
                                  {
                                    cartCourse?.course_img?.map((img, index) => (
                                      <img
                                        key={index}
                                        src={img.url}
                              ...
                              <div className="col-sm-8">
                                <h6 className="mb-0">
                                  <a href="#">{cartCourse.course_name}</a>
                                </h6>
                                ...
                                <div className="d-flex justify-content-between align-items-center mt-3">
                                  ...
                                  <div className="text-primary-hover">
                                    <p href="#" className="text-body me-2" onClick={() => handledelete(item._id)}>
                    ...
                    <p className="small mb-0 mt-2 text-center">By completing your purchase, you agree to
                      these <a href="#"><strong>Terms of Service</strong></a></p>
                  </div>
                  {/* Order summary END */}
                </div>
                <div className="col-md-6 col-xl-12">
                  <div className="card bg-blue p-3 position-relative overflow-hidden" style={{ background: 'url(assets/images/pattern/05.png) no-repeat center center', backgroundSize: 'cover' }}>
                    ...
                    <div className="card-body">
                      {/* Title */}
                      <h5 className="card-title text-white mb-2">Access 25K Online courses from 120
                        institutions, Start today!</h5>
                      <p className="text-white text-opacity-75">Here is the description of premium
                        features which will allow users to get benefits and save a lot of money</p>
                      {/* Button */}
