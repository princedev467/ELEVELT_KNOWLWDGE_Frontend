    ...
    <div className="container position-relative">
      <div className="row g-5 align-items-center justify-content-center">
        <div className="col-lg-5">
          ...
          {/* info */}
          <p>Hey you! Eduport is coming. We are doing our best to launch our website and we will be back
            soon.</p>
          {/* Progress bar */}
          <div className="overflow-hidden mt-4">
            ...
            <div className="progress progress-md progress-percent-bg bg-light">
              <div className="progress-bar progress-bar-striped bg-blue aos" data-aos="slide-right" data-aos-delay={200} data-aos-duration={1000} data-aos-easing="ease-in-out" role="progressbar" aria-valuenow={85} aria-valuemin={0} aria-valuemax={100} style={{width: '85%'}}>
        ...
        <div className="col-lg-7 text-center">
          {/* Image */}
          <img src="assets/images/element/coming-soon.svg" className="h-300px h-sm-400px h-md-500px h-xl-700px" alt />
        </div>
      </div>
    </div>
  </section>
