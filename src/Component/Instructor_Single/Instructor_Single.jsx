...
function Instructor_Single(props) {
    return (
    <main>
  {/* =======================
Page content START */}
            ...
            <div className="col-md-6 col-lg-12">
              <div className="card card-body shadow p-4 mb-4">
                ...
                <div className="d-flex align-items-center mb-4">
                  <span className="icon-md text-dark mb-0 bg-light rounded-3"><i className="fas fa-graduation-cap" /></span>
                  <div className="ms-3">
            ...
            <div className="position-relative">
              ...
              <div className="card-img-overlay d-flex flex-column p-3">
                <div className="w-100 mt-auto text-end">
                  {/* Card category */}
                  <a href="#" className="badge text-white bg-info rounded-1"><i className="fas fa-user-graduate me-2" />25</a>
                  <a href="#" className="badge text-white bg-orange rounded-1"><i className="fas fa-clipboard-list me-2" />15</a>
                </div>
              </div>
            </div>
            {/* Card body */}
           ...
           <SwiperSlide>
            ...
            <div className="position-relative">
              ...
              <div className="card-img-overlay d-flex flex-column p-3">
                <div className="w-100 mt-auto text-end">
                  {/* Card category */}
                  <a href="#" className="badge text-white bg-info rounded-1"><i className="fas fa-user-graduate me-2" />118</a>
                  <a href="#" className="badge text-white bg-orange rounded-1"><i className="fas fa-clipboard-list me-2" />09</a>
                </div>
              </div>
            </div>
            {/* Card body */}
           ...
           <SwiperSlide>
            ...
            <div className="position-relative">
              ...
              <div className="card-img-overlay d-flex flex-column p-3">
                <div className="w-100 mt-auto text-end">
                  {/* Card category */}
                  <a href="#" className="badge text-white bg-info rounded-1"><i className="fas fa-user-graduate me-2" />92</a>
                  <a href="#" className="badge text-white bg-orange rounded-1"><i className="fas fa-clipboard-list me-2" />38</a>
                </div>
              </div>
            </div>
            {/* Card body */}
           ...
           <SwiperSlide>
            ...
            <div className="position-relative">
              ...
              <div className="card-img-overlay d-flex flex-column p-3">
                <div className="w-100 mt-auto text-end">
                  {/* Card category */}
                  <a href="#" className="badge text-white bg-info rounded-1"><i className="fas fa-user-graduate me-2" />82</a>
                  <a href="#" className="badge text-white bg-orange rounded-1"><i className="fas fa-clipboard-list me-2" />05</a>
                </div>
              </div>
            </div>
            {/* Card body */}
           ...
           <SwiperSlide>
            ...
            <div className="position-relative">
              ...
              <div className="card-img-overlay d-flex flex-column p-3">
                <div className="w-100 mt-auto text-end">
                  {/* Card category */}
                  <a href="#" className="badge text-white bg-info rounded-1"><i className="fas fa-user-graduate me-2" />50</a>
                  <a href="#" className="badge text-white bg-orange rounded-1"><i className="fas fa-clipboard-list me-2" />10</a>
                </div>
              </div>
            </div>
            {/* Card body */}
