                  ...
                  <div className="offcanvas-body p-3 p-xl-0">
                    <div className="card border rounded-3 pb-0 p-3 w-100">
                      ...
                      <div className="list-group list-group-dark list-group-borderless">
                        ...
                        <NavLink to={`/Instructor_Create_Course/${auth?.auth?._id}`} className="list-group-item active"><i className="bi bi-basket fa-fw me-2" />My course</NavLink>
                        ...
                        <NavLink className="list-group-item text-danger bg-danger-soft-hover"
                          ...
                          to={'/'}><i className="fas fa-sign-out-alt fa-fw me-2" />Sign Out</NavLink>  </div>
                    </div>
                  </div>
                </div>
              </nav>
