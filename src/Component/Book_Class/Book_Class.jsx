          ...
          <div className="row mt-4">
            ...
            <div className="col-12 mb-5">
              <div className="d-flex align-items-center">
                {/* Image */}
                <div>
                  <div className="icon-xl bg-white shadow rounded-circle">
                    <img src="assets/images/element/child.svg" className="h-40px" alt />
                  </div>
                </div>
                {/* Title */}
                <div className="ms-3">
                  <h5 className="mb-0">We care about students</h5>
                  <p className="text-truncate-2 mb-0">Man children rejoiced yet uncommonly his ten
                    who. Yet uncommonly his ten who diminution astonished.</p>
                </div>
              </div>
            </div>
            {/* Item */}
            <div className="col-12 mb-5">
              <div className="d-flex align-items-center">
                ...
                <div>
                  <div className="icon-xl bg-white shadow rounded-circle">
                    <img src="assets/images/element/help.svg" className="h-40px" alt />
                  </div>
                </div>
                {/* Title */}
                <div className="ms-3">
                  <h5 className="mb-0">Helping struggling students</h5>
                  <p className="text-truncate-2 mb-0">Children rejoiced yet uncommonly his ten who.
          ...
          <div className="bg-primary bg-opacity-10 rounded-3 p-4 p-sm-5">
            ...
            <form className="row g-4 g-sm-3 mt-2 mb-0">
              ...
              <div className="col-12">
                ...
                <input type="text" className="form-control" aria-label="Mobile number" />
              </div>
              {/* Category */}
              <div className="col-12">
