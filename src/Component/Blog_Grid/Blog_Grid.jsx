        ...
        <div className="col-sm-6 col-lg-4 col-xl-3">
          <div className="card">
            <div className="overflow-hidden rounded-3">
              ...
              <div className="card-img-overlay d-flex align-items-start p-3">
                {/* badge */}
                <a href="#" className="badge bg-success text-white">Student life</a>
              </div>
            </div>
            {/* Card body */}
            <div className="card-body">
        ...
        <div className="col-sm-6 col-lg-4 col-xl-3">
          <div className="card">
            <div className="overflow-hidden rounded-3">
              ...
              <div className="card-img-overlay d-flex align-items-start p-3">
                {/* badge */}
                <a href="#" className="badge bg-purple text-white">Travel</a>
              </div>
            </div>
            {/* Card body */}
            <div className="card-body">
        ...
        <div className="col-sm-6 col-lg-4 col-xl-3">
          <div className="card">
            <div className="overflow-hidden rounded-3">
              ...
              <div className="card-img-overlay d-flex align-items-start p-3">
                {/* badge */}
                <a href="#" className="badge bg-danger text-white">Research</a>
              </div>
            </div>
            {/* Card body */}
            <div className="card-body">
        ...
        <div className="col-sm-6 col-lg-4 col-xl-3">
          <div className="card">
            <div className="overflow-hidden rounded-3">
              ...
              <div className="card-img-overlay d-flex align-items-start p-3">
                {/* badge */}
                <a href="#" className="badge bg-success text-white">Research</a>
              </div>
            </div>
            {/* Card body */}
            <div className="card-body">
        ...
        <div className="col-sm-6 col-lg-4 col-xl-3">
          <div className="card">
            <div className="overflow-hidden rounded-3">
              ...
              <div className="card-img-overlay d-flex align-items-start p-3">
                {/* badge */}
                <a href="#" className="badge bg-orange text-white">Marketing</a>
              </div>
            </div>
            {/* Card body */}
            <div className="card-body">
